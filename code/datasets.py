...
class TextDataset(data.Dataset):
            ...
            with open(cap_path, "rb") as f:
                ...
                for cap in captions:
                    ...
                    if cnt == self.embeddings_num:
                        break
                capti = clip.tokenize(capTAmp,truncate = True)
                all_captions.append(capti)
                if cnt < self.embeddings_num:
    ...
    def get_caption(self, sent_ix):
        ...
        new_sent_ix = random.randint(0, self.embeddings_num)
        sent_caption = np.asarray(self.captions[sent_ix][new_sent_ix]).astype('int64')
